                ...
                <div class="table-responsive" data-toggle="lists" data-lists-values='["js-lists-values-employee-name"]'>
                    ...
                    <table class="table mb-0 thead-border-top-0 table-striped">
                        <thead>
                            ...
                            <th style="width: 40px;"> {{ trans('admin.role') }} </th>
                        ...
                        <tr>
                            ...
                            <td style="width: 40px">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center btn btn-{{ $account->role == 1 ? 'success' : 'primary'}} ">
                                         {{ $account->role == 1 ? __('admin.doctor') : __('admin.nursery') }}
                                    </div>
                                </div>
                            </td>

                            <td style="width:120px" class="text-center">
                                <img src="{{ $account->admin_image }}" style="width: 120px; height: 50px">
                            </td>

                            <td>
                                <a href="{{ route('accounts.edit', $account->id) }}" class="btn btn-sm btn-link">
