    ...
    <div class="mdk-drawer-layout__content page">
        <div class="container-fluid page__heading-container">
            <div class="page__heading d-flex align-items-center">
                ...
                <a href="{{ route('reservations.create') }}" class="btn btn-success ml-3">{{ trans('admin.create') }} <i class="material-icons">add</i></a>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td style="width: 40px;">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        {{ ucfirst($reservation->doctor->name) }}
                                    </div>
                                </div>
                            </td>
                            <td style="width: 40px;">
                            ...
                            <td style="width: 40px">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        {{ ucfirst($reservation->creator) }}
                                    </div>
                                </div>
                            </td>

                            <td style="width: 30px;">
                                <a href="{{ route('reservations.edit', $reservation->id) }}" class="btn btn-sm btn-link">
