                    ...
                    <table class="table mb-0 thead-border-top-0 table-striped">
                        ...
                        <tr>
                            ...
                            <td style="width: 120px;">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        {{ substr($teamMember->ar_description, 0, 20) }}
                                    </div>
                                </div>
                            </td>
                            <td style="width: 120px;">
                            ...
                            <td style="width: 40px">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center btn btn-{{ $teamMember->role == 1 ? 'success' : 'primary'}} ">
                                         {{ $teamMember->role == 1 ? __('admin.doctor') : __('admin.nursery') }}
                                    </div>
                                </div>
                            </td>
