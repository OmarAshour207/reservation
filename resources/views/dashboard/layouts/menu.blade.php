    ...
    <div class="mdk-drawer__content">
        <div class="sidebar sidebar-dark sidebar-left sidebar-p-t bg-dark" data-perfect-scrollbar>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button" href="{{ route('reservations.index') }}">
                        <i class="sidebar-menu-icon sidebar-menu-icon--left fa fa-clock"></i>
                        <span class="sidebar-menu-text">  {{ __('admin.reservations') }} </span>
                    </a>
                </li>
                ...
                @if (admin()->user()->role == 0)
                    <li class="sidebar-menu-item">
                        <a class="sidebar-menu-button" href="{{ route('accounts.index') }}">
                            ...
                            <span class="sidebar-menu-text">  {{ __('admin.accounts') }} </span>
                        </a>
                    </li>
                @endif
                    ...
                    <ul class="sidebar-submenu collapse" id="dashboards_clients">
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="{{ route('clients-histories.index') }}">
                                ...
                                <span class="sidebar-menu-text">  {{ __('admin.clients_histories') }} </span>
                            </a>
                        </li>
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="{{ route('clients-histories.create') }}">
            ...
            <div class="d-flex align-items-center sidebar-p-a border-bottom sidebar-account">
                <a href="{{ route('edit.profile') }}" class="flex d-flex align-items-center text-underline-0 text-body">
                    <span class="avatar avatar-sm mr-2">
                        <img src="{{ admin()->user() ->admin_image}}" alt="avatar" class="avatar-img rounded-circle">
                    </span>
