                ...
                <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                    ...
                    <ul class="nav navbar-nav">
                        <li class="{{ setActiveHome('') }}">
                            <a href="{{ url('/') }}"><i class="fa fa-home" style="font-size: 18px;"></i> {{ __('home.home') }} </a>
                        </li>
                        <li class="{{ setActive('about') }}">
                            <a href="{{ url('about') }}"> <i class="fa fa-info" style="font-size: 18px;"></i> {{ __('home.about_us') }} </a>
                        </li>
                        <li class="{{ setActive('services') }}">
                            <a href="{{ url('services') }}">
                                <i class="fa fa-wrench"  style="font-size: 18px;"></i> {{ __('home.our_services') }}
                            </a>
                        </li>
                        <li class="{{ setActive('projects') }}">
                            <a href="{{ url('projects') }}"><i class="fa fa-warehouse" style="font-size: 18px;"></i> {{ __('home.our_projects') }}</a>
                        </li>
                        <li class="{{ setActive('blogs') }}">
                            <a href="{{ url('blogs') }}">
                                <i class="fa fa-book" style="font-size: 18px"></i> {{ trans('home.blogs') }}
                            </a>
                        </li>
